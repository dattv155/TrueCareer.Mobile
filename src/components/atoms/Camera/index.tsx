...
import {getImageNameByUri} from 'src/helpers/file-helper';
import {useCamera} from 'src/services/use-camera';
    ...
    <>
      ...
      <SafeAreaView style={styles.bottom}>
        <TouchableOpacity style={styles.changeCamera} onPress={onCancel}>
          <SvgIcon component={require('assets/icons/clear-white.svg')} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.shotBtn} onPress={handleCapture}>
          <SvgIcon component={require('assets/icons/shot-button.svg')} />
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.changeCamera}
          onPress={handleChangeCamera}>
          <SvgIcon component={require('assets/icons/change-camera.svg')} />
        </TouchableOpacity>
      </SafeAreaView>
      {currentImage && (
