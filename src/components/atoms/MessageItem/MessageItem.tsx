    ...
    <>
      {swipe && (
        <View
          ...
          <SvgIcon component={require('assets/icons/reply-svgrepo-com.svg')} />
        </View>
      )}
            ...
            {conversationMessage?.globalUserId === globalUser?.id ? (
              ...
              <View
                    ...
                    <Image
                      ...
                      source={
                        conversationMessage?.globalUser?.avatar
                          ? {
                              uri: conversationMessage.globalUser.avatar,
                            }
                ...
                <ContentItem
                  conversationMessage={conversationMessage}
                  onPress={handleShow}
                  isOther={conversationMessage?.globalUserId !== globalUser?.id}
                  onLongPress={() => {
                    if (onSwipe) {
                      onSwipe(conversationMessage);
                    }
